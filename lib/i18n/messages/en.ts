...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "subagent.waitingFor": "Waiting for: {ids}",
    "subagent.checkpoint": "Checkpoint (unverified, not completion)",
    "subagent.remaining": "Remaining: {text}",
    "subagent.blocked": "Blocked: {text}",
    "subagent.budgetExceeded": "Soft budget exceeded — reassess scope, not a failure.",
    "subagent.statusUnavailable": "Status refresh paused; open the agent session to check.",
    ...
    "persona.saved": "Saved",
    "persona.placeholder": "# Edit your user persona here…",
    "persona.hint": "Saved to ~/.pi/agent/persona.md and injected into the system prompt every turn; takes effect on the next message.",
    ...
    "files.changedCountTruncated": "{count}+ entries",
    "files.listTruncated": "Partial Git results: scan limit reached. Narrow the directory scope.",
    "files.lineStatsIncomplete": "Line counts are incomplete due to a limit or error.",
    "files.trackedOnly": "Tracked only",
    "files.trackedOnlyTooltip": "Remote untracked file contents are not read automatically to calculate line counts.",
    ...
    "chat.fileUploadNoCwd": "No working directory available for file upload",
    ...
    "chat.temperatureHint": "Sampling temperature: higher values make model output more random. Applies to this session only; the server accepts 0–2.",
    "chat.changeTemperatureLabel": "Change sampling temperature",
    "chat.temperatureDefault": "Default",
    "chat.temperatureDefaultDesc": "Use the provider default",
    "chat.temperatureZeroDesc": "Deterministic output, code generation",
    "chat.temperatureLowDesc": "Precise Q&A, fewer hallucinations",
    "chat.temperatureMidDesc": "Everyday chat (recommended)",
    "chat.temperatureHighDesc": "Open conversation, brainstorming",
    "chat.temperatureVhighDesc": "Creative writing, role-play",
    "chat.temperatureMaxDesc": "Max randomness, may drift",
    "chat.temperatureRecommended": "Recommended range 0.5–1.0: 0–0.5 for code/precise tasks, 0.7 for everyday Q&A, 1.0–1.5 for creative work; values above 2.0 are rejected by the server.",
    "chat.temperatureSet": "Set",
    "chat.temperatureCustomLabel": "Custom temperature (0–2)",
    "chat.temperatureLabel": "Temperature",
    "chat.topPLabel": "top_p (nucleus)",
    "chat.topKLabel": "top_k (candidate limit)",
    "chat.topPCustomLabel": "Custom top_p (0–1)",
    "chat.topKCustomLabel": "Custom top_k (integer 1–1000)",
    "chat.topPLowDesc": "Tighter truncation, steadier output",
    "chat.topPMidDesc": "Common balanced value",
    "chat.topPModelDesc": "Typical model default",
    "chat.topPOffDesc": "No cumulative-probability cutoff",
    "chat.topKNarrowDesc": "Narrow, more deterministic",
    "chat.topKMidDesc": "Moderate width",
    "chat.topKWideDesc": "Wider tail, less repetition",
    "chat.topKWidestDesc": "Widest",
    "chat.samplingTabTemperature": "Temp",
    "chat.samplingDefaultShort": "default",
    "chat.samplingExtrasHint": "When empty the field is not sent and the server decides (a local vLLM reads the model's generation_config.json, e.g. top_k=20 / top_p=0.95).",
    "chat.topKProviderHint": "If the model seems stuck in a loop, widen top_k first. Note: the official OpenAI endpoint rejects top_k.",
    "chat.stopCompaction": "Stop compaction",
    "chat.compactContext": "Compact context",
    "chat.compactionSettings": "Compaction settings",
    "chat.compactionModel": "Compaction model",
    "chat.compactionThinking": "Compaction thinking",
    "chat.compactionCacheAligned": "Cache-aligned mode",
    "chat.compactionCacheAlignedHint": "Reuse the session prompt and full history to hit server-side prefix cache (needs backend prefix caching, e.g. vLLM APC)",
    "chat.followSession": "Follow session",
    ...
    "bundled.title": "Bundled extensions (shipped with pi-web)",
    "bundled.install": "Install",
    "bundled.installing": "Installing…",
