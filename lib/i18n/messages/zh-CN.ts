...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "subagent.waitingFor": "等待依赖：{ids}",
    "subagent.checkpoint": "阶段汇报（待验证，不代表完成）",
    "subagent.remaining": "剩余工作：{text}",
    "subagent.blocked": "阻塞原因：{text}",
    "subagent.budgetExceeded": "已达到软预算，请重新评估任务范围；不代表失败。",
    "subagent.statusUnavailable": "状态刷新已暂停，请打开子代理会话核查。",
    ...
    "persona.saving": "保存中…",
    "persona.saved": "已保存",
    "persona.placeholder": "# 在这里编辑你的用户人设…",
    "persona.hint": "人设保存在 ~/.pi/agent/persona.md，每轮对话自动注入系统提示词，保存后下一条消息生效。",
    ...
    "files.changedCountTruncated": "{count}+ 个变更项",
    "files.listTruncated": "Git 结果不完整：已达到扫描限制。请缩小目录范围。",
    "files.lineStatsIncomplete": "因限制或错误，行数统计未完成。",
    "files.trackedOnly": "仅已跟踪",
    "files.trackedOnlyTooltip": "远程未跟踪文件不自动读取内容计算行数",
    ...
    "chat.fileUploadNoCwd": "当前没有可用的工作目录，无法上传文件",
    ...
    "chat.temperatureHint": "采样温度：数值越高，模型输出越随机。仅对本会话生效，服务端接受 0–2。",
    "chat.changeTemperatureLabel": "更改采样温度",
    "chat.temperatureDefault": "默认",
    "chat.temperatureDefaultDesc": "使用服务端默认值",
    "chat.temperatureZeroDesc": "确定性输出，代码生成",
    "chat.temperatureLowDesc": "精确问答，幻觉更少",
    "chat.temperatureMidDesc": "日常对话（推荐）",
    "chat.temperatureHighDesc": "开放对话、头脑风暴",
    "chat.temperatureVhighDesc": "创意写作、角色扮演",
    "chat.temperatureMaxDesc": "最大随机性，可能跑偏",
    "chat.temperatureRecommended": "建议范围 0.5–1.0：代码/精确任务 0–0.5，日常问答 0.7，创意任务 1.0–1.5；超过 2.0 服务端会拒绝。",
    "chat.temperatureSet": "设置",
    "chat.temperatureCustomLabel": "自定义温度（0–2）",
    "chat.temperatureLabel": "温度 temperature",
    "chat.topPLabel": "top_p（核采样）",
    "chat.topKLabel": "top_k（候选数上限）",
    "chat.topPCustomLabel": "自定义 top_p（0–1）",
    "chat.topKCustomLabel": "自定义 top_k（1–1000 整数）",
    "chat.topPLowDesc": "长尾截得更紧，输出更稳",
    "chat.topPMidDesc": "常用平衡值",
    "chat.topPModelDesc": "多数模型的默认值",
    "chat.topPOffDesc": "不按累积概率截断",
    "chat.topKNarrowDesc": "窄，输出更确定",
    "chat.topKMidDesc": "中等宽度",
    "chat.topKWideDesc": "放宽长尾，更不易复读",
    "chat.topKWidestDesc": "最宽",
    "chat.samplingTabTemperature": "温度",
    "chat.samplingDefaultShort": "默认",
    "chat.samplingExtrasHint": "为空时不下发该字段，由服务端决定（本地 vLLM 会读出模型 generation_config.json 的值，例如 top_k=20 / top_p=0.95）。",
    "chat.topKProviderHint": "疑似死循环时先放宽 top_k。注意：官方 OpenAI 端点不接受 top_k。",
    "chat.stopCompaction": "停止压缩",
    "chat.compactContext": "压缩上下文",
    "chat.compactionSettings": "压缩设置",
    "chat.compactionModel": "压缩模型",
    "chat.compactionThinking": "压缩思考档位",
    "chat.compactionCacheAligned": "缓存对齐模式",
    "chat.compactionCacheAlignedHint": "复用会话提示词与完整历史，命中服务端前缀缓存（需后端开启前缀缓存，如 vLLM APC）",
    "chat.followSession": "跟随会话",
    ...
    "i18n.checking": "检查中...",
    "i18n.install": "安装",
    "bundled.title": "内置扩展（随项目附带）",
    "bundled.install": "安装",
    "bundled.installing": "安装中…",
    "bundled.installed": "已装",
    "i18n.installing": "安装中...",
    "i18n.noResults": "没有结果",
