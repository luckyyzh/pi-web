...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "subagent.waitingFor": "等待相依任務：{ids}",
    "subagent.checkpoint": "階段回報（待驗證，不代表完成）",
    "subagent.remaining": "剩餘工作：{text}",
    "subagent.blocked": "阻塞原因：{text}",
    "subagent.budgetExceeded": "已達到軟預算，請重新評估任務範圍；不代表失敗。",
    "subagent.statusUnavailable": "狀態更新已暫停，請開啟子代理工作階段確認。",
    ...
    "files.changedCountTruncated": "{count}+ 個變更項目",
    "files.listTruncated": "Git 結果不完整：已達到掃描限制。請縮小目錄範圍。",
    "files.lineStatsIncomplete": "因限制或錯誤，行數統計未完成。",
    "files.trackedOnly": "僅已追蹤",
    "files.trackedOnlyTooltip": "遠端未追蹤檔案不自動讀取內容計算行數",
    ...
    "chat.fileUploadFailed": "檔案上傳失敗",
    "chat.fileUploadNoCwd": "目前沒有可用的工作目錄，無法上傳檔案",
    ...
    "chat.temperatureHint": "採樣溫度：數值越高，模型輸出越隨機。僅對本會話生效，伺服器端接受 0–2。",
    "chat.changeTemperatureLabel": "更改採樣溫度",
    "chat.temperatureDefault": "預設",
    "chat.temperatureDefaultDesc": "使用伺服器端預設值",
    "chat.temperatureZeroDesc": "確定性輸出，程式碼生成",
    "chat.temperatureLowDesc": "精確問答，幻覺更少",
    "chat.temperatureMidDesc": "日常對話（推薦）",
    "chat.temperatureHighDesc": "開放對話、頭腦風暴",
    "chat.temperatureVhighDesc": "創意寫作、角色扮演",
    "chat.temperatureMaxDesc": "最大隨機性，可能跑偏",
    "chat.temperatureRecommended": "建議範圍 0.5–1.0：程式碼/精確任務 0–0.5，日常問答 0.7，創意任務 1.0–1.5；超過 2.0 伺服器端會拒絕。",
    "chat.temperatureSet": "設定",
    "chat.temperatureCustomLabel": "自訂溫度（0–2）",
    "chat.temperatureLabel": "溫度 temperature",
    "chat.topPLabel": "top_p（核採樣）",
    "chat.topKLabel": "top_k（候選數上限）",
    "chat.topPCustomLabel": "自訂 top_p（0–1）",
    "chat.topKCustomLabel": "自訂 top_k（1–1000 整數）",
    "chat.topPLowDesc": "長尾截得更緊，輸出更穩",
    "chat.topPMidDesc": "常用平衡值",
    "chat.topPModelDesc": "多數模型的預設值",
    "chat.topPOffDesc": "不依累積機率截斷",
    "chat.topKNarrowDesc": "窄，輸出更確定",
    "chat.topKMidDesc": "中等寬度",
    "chat.topKWideDesc": "放寬長尾，較不易複讀",
    "chat.topKWidestDesc": "最寬",
    "chat.samplingTabTemperature": "溫度",
    "chat.samplingDefaultShort": "預設",
    "chat.samplingExtrasHint": "為空時不下發該欄位，由伺服器端決定（本地 vLLM 會讀取模型 generation_config.json 的值，例如 top_k=20 / top_p=0.95）。",
    "chat.topKProviderHint": "疑似死循環時先放寬 top_k。注意：官方 OpenAI 端點不接受 top_k。",
    "chat.stopCompaction": "停止壓縮",
    "chat.compactContext": "壓縮上下文",
    "chat.compactionSettings": "壓縮設定",
    "chat.compactionModel": "壓縮模型",
    "chat.compactionThinking": "壓縮思考檔位",
    "chat.compactionCacheAligned": "快取對齊模式",
    "chat.compactionCacheAlignedHint": "複用會話提示詞與完整歷史，命中服務端前綴快取（需後端開啟前綴快取，如 vLLM APC）",
    "chat.followSession": "跟隨會話",
    "chat.resetToDefault": "恢復預設",
