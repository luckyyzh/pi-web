...
test("all locales explain how built-in profile edits are saved", () => {
  for (const locale of getSupportedLocales()) {
    const message = getLocalePlugin(locale).messages["agents.builtinEditHint"];
    assert.equal(typeof message, "string", `${locale} needs the built-in editing hint`);
